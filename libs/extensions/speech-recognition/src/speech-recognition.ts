...
export const SpeechRecognition = SR_Node.create<SpeechRecognitionOptions>({
  ...
  onCreate() {
    if (
      ...
      console.warn(
        '"@ccreusat-monorepo/tiptap-extension-speechrecognition" requires a browser supporting the SpeechRecognition API".'
      );
    }
  },
      ...
      startSpeechRecognition:
        ...
        ({ commands }) => {
          ...
          this.recognition.onerror = (event: SpeechRecognitionErrorEvent) => {
            ...
            console.log(
              `[@ccreusat-monorepo/tiptap-extension-speechrecognition][error][${event.error}]: ${event.message}`
            );
          };
