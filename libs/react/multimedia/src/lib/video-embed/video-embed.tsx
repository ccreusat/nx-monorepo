...
import { ArrowRight, Globe } from '@ccreusat-monorepo/icons';
import { Embedder, odeServices } from '@ccreusat-monorepo/client';
...
import { useMediaLibraryContext } from '../media-library/media-library.context';

export interface VideoEmbedProps {
  onSuccess: (resource?: string) => void;
}

export const VideoEmbed = ({ onSuccess }: VideoEmbedProps) => {
