...
import { IOdeTheme } from '@ccreusat-monorepo/client';
import { useOdeClient } from '../ode-client-provider/ode-client-provider';
import useConf from '../../core/use-conf/use-conf';
...
export function useOdeTheme() {
  ...
  if (!context) {
    throw new Error(`Cannot be used outside of ThemeProvider`);
  }
  return context;
}
